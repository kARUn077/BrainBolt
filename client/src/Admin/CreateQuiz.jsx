...
function CreateQuiz() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        axios.post('http://localhost:4000/createQuiz', { quizName, duration, topics, quizDate, quizTime, instructions })
            .then(result => {
    ...
    const addQuestion = (e) => {
        e.preventDefault()
        axios.post('http://localhost:4000/addQuestion', { quizName, question, opt1, opt2, opt3, opt4, answer })
            .then(result => {
    ...
    const showQuestion = async () => {
        const result = await axios.post('http://localhost:4000/showQuestion', { quizName });
        setValues(result.data.data);
    }

    const deleteQuestion = async (questionName) => {
        const result = await axios.post('http://localhost:4000/deleteQuestion', { quizName, questionName });
