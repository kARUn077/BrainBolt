                ...
                <div class="row gx-5 ">
                    <div class="col ">
                        <div class="shadow p-3 mb-5 bg-body-tertiary rounded">
                            <h3>Karun Poddar</h3>
                            <p><ImEnvelop /> karun.20224078@mnnit.ac.in</p>
                            <br />
                            <div class="container px-4 text-center">
                                <div class="row gx-5 p-3 mb-2 bg-success-subtle text-dark">
                                    <div class="col">
                                        <div style={{ textAlign: "left" }}>
                                            <h5>Social Media</h5>
                                            <a href="https://www.linkedin.com/in/karun-poddar-515b23264/" style={{textDecoration:"none",color:"black"}} ><ImLinkedin /> karun-poddar-515b23264 </a>
                                            <br/><br/>
                                            <a href="https://github.com/kARUn077" style={{textDecoration:"none",color:"black"}}><DiGithubBadge />kARUn077</a>
                                            <br/><br/>
                                            <a href="https://www.instagram.com/me_kirtan_17/" style={{textDecoration:"none",color:"black"}} ><FaInstagram /> me_kirtan_17</a>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="p-3">
